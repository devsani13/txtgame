...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['conq']) && isset($_POST['score']) && $_POST['score'] == 15 && isset($_POST['modo']) && $_POST['modo'] == 'normal') {
    $sql_update = "UPDATE perfilconquistas SET yeonjunn = 1 WHERE usuario = '$usuario'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['conq']) && isset($_POST['score']) && $_POST['score'] == 15 && isset($_POST['modo']) && $_POST['modo'] == 'cronometrado') {
    $sql_update = "UPDATE perfilconquistas SET yeonjunc = 1 WHERE usuario = '$usuario'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['conq']) && isset($_POST['score']) && $_POST['score'] == 15 && isset($_POST['modo']) && $_POST['modo'] == 'infinito') {
    $sql_update = "UPDATE perfilconquistas SET yeonjuni = 1 WHERE usuario = '$usuario'";
...
<style>
    body {
        ...
        background-image: url('hwangchoon.jpg');
...
<body>
    ...
    <div id="game-container" style="display: none;">
        ...
        <div id="button-container">
            ...
            <button id="backButton">
                <img src="voltarblack.png" alt="Voltar" onclick="window.location.href='yeonjun.php';">
            </button>
        </div>
    ...
    <script>
        const questions = [
            { question: "1 - Qual é o nome completo de Yeonjun?", options: ["Choi Yeonjun", "Choi Junho", "Choi Yunjun", "Choi Yunho"], answer: 0 },
            { question: "2 - Qual é a data de nascimento de Yeonjun?", options: ["13 de setembro de 1999", "13 de setembro de 2000", "4 de outubro de 1999", "4 de outubro de 2000"], answer: 1 },
            { question: "3 - Qual é o signo de Yeonjun?", options: ["Virgem", "Libra", "Escorpião", "Leão"], answer: 1 },
            { question: "4 - Qual é a altura de Yeonjun?", options: ["182 cm", "181 cm", "180 cm", "179 cm"], answer: 1 },
            { question: "5 - Qual é o tipo sanguíneo de Yeonjun?", options: ["A", "B", "AB", "O"], answer: 0 },
            { question: "6 - Qual é o MBTI de Yeonjun?", options: ["ENTP", "ENFP", "INFJ", "ISFP"], answer: 1 },
            { question: "7 - Qual é a flor representativa de Yeonjun?", options: ["Tulipa", "Girassol", "Orquídea", "Hortênsia"], answer: 0 },
            { question: "8 - Qual é o apelido de Yeonjun?", options: ["Yeonnie", "Yjun", "Fox", "Todos os anteriores"], answer: 3 },
            { question: "9 - Qual é o prato favorito de Yeonjun?", options: ["Pizza", "Kimchi", "Churrasco coreano", "Frango"], answer: 2 },
            { question: "10 - Qual é o hobby de Yeonjun?", options: ["Desenhar", "Dançar", "Cantar", "Ler mangás"], answer: 1 },
            { question: "11 - Qual é o emoji representativo de Yeonjun?", options: ["🦊", "🐻", "🐱", "🐦"], answer: 0 },
            { question: "12 - Qual é a cor favorita de Yeonjun?", options: ["Rosa", "Preto", "Verde", "Azul"], answer: 3 },
            { question: "13 - Qual é a comida que Yeonjun não gosta?", options: ["Peixe", "Frutos do mar", "Abacate", "Legumes"], answer: 1 },
            { question: "14 - Qual é o talento especial de Yeonjun?", options: ["Imitar danças de outros artistas", "Cantar em várias línguas", "Ser extremamente flexível", "Desenhar rapidamente"], answer: 0 },
            { question: "15 - Qual é a fruta favorita de Yeonjun?", options: ["Melancia", "Morango", "Abacaxi", "Manga"], answer: 1 },
        ];
