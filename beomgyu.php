...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['conq']) && isset($_POST['score']) && $_POST['score'] == 15 && isset($_POST['modo']) && $_POST['modo'] == 'normal') {
    $sql_update = "UPDATE perfilconquistas SET beomgyun = 1 WHERE usuario = '$usuario'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['conq']) && isset($_POST['score']) && $_POST['score'] == 15 && isset($_POST['modo']) && $_POST['modo'] == 'cronometrado') {
    $sql_update = "UPDATE perfilconquistas SET beomgyuc = 1 WHERE usuario = '$usuario'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['conq']) && isset($_POST['score']) && $_POST['score'] == 15 && isset($_POST['modo']) && $_POST['modo'] == 'infinito') {
    $sql_update = "UPDATE perfilconquistas SET beomgyui = 1 WHERE usuario = '$usuario'";
...
<style>
    body {
        ...
        background-image: url('bamgeut.jpg');
...
<body>
    ...
    <div id="game-container" style="display: none;">
        ...
        <div id="button-container">
            ...
            <button id="backButton">
                <img src="voltarblack.png" alt="Voltar" onclick="window.location.href='beomgyu.php';">
            </button>
        </div>
    ...
    <script>
    const questions = [
    { question: "1 - Qual é o nome completo de Beomgyu?", options: ["Choi Beomgyu", "Choi Beomjoon", "Choi Gyubeom", "Choi Byunggyu"], answer: 0 },
    { question: "2 - Qual é a data de nascimento de Beomgyu?", options: ["5 de março de 2001", "13 de março de 2001", "10 de abril de 2000", "18 de novembro de 2001"], answer: 1 },
    { question: "3 - Qual é o signo de Beomgyu?", options: ["Peixes", "Áries", "Leão", "Gêmeos"], answer: 0 },
    { question: "4 - Qual é a altura de Beomgyu?", options: ["179 cm", "178 cm", "180 cm", "177 cm"], answer: 2 },
    { question: "5 - Qual é o tipo sanguíneo de Beomgyu?", options: ["A", "B", "AB", "O"], answer: 3 },
    { question: "6 - Qual é o MBTI de Beomgyu?", options: ["ENFP", "ISTP", "ENFJ", "ENTP"], answer: 2 },
    { question: "7 - De qual cidade Beomgyu é natural?", options: ["Seul", "Incheon", "Daegu", "Busan"], answer: 2 },
    { question: "8 - Que instrumento Beomgyu sabe tocar?", options: ["Violão", "Piano", "Bateria", "Guitarra elétrica"], answer: 3 },
    { question: "9 - Qual é o apelido de Beomgyu?", options: ["Gyugyu", "Bamgyu", "Beombear", "Todos os anteriores"], answer: 3 },
    { question: "10 - Qual é o hobby de Beomgyu?", options: ["Ouvir música", "Fotografar", "Jogar videogame", "Viajar"], answer: 0 },
    { question: "11- Qual é o emoji representativo de Beomgyu?", options: ["🐻", "🐥", "🐦", "🐱"], answer: 0 },
    { question: "12 - Qual é o prato favorito de Beomgyu?", options: ["Frango frito", "Ramen", "Kimchi", "Pizza"], answer: 0 },
    { question: "13 - Qual é o hábito peculiar de Beomgyu?", options: ["Falar enquanto dorme", "Dormir com meias", "Roncar alto", "Fazer caretas"], answer: 0 },
    { question: "14 - Qual é o ponto forte de Beomgyu segundo ele mesmo?", options: ["Seu humor", "Sua liderança", "Sua energia", "Sua empatia"], answer: 2 },
    { question: "15 - Qual é a comida que Beomgyu não gosta?", options: ["Pepino", "Tomate", "Cenoura", "Espinafre"], answer: 1 },
];
